...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Env :  IEquatable<Env>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Env" /> class.
        /// </summary>
        /// <param name="scope">scope (required).</param>
        public Env(EnvScope scope = default(EnvScope))
        {
            // to ensure "scope" is required (not null)
            if (scope == null)
            {
                throw new InvalidDataException("scope is a required property for Env and cannot be null");
            }
            else
            {
                this.Scope = scope;
